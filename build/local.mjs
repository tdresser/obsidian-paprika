...
var init_obsidian_paprika_bg = __esm({
  "wasm-deferred:/Users/tdresser/personal/git/obsidian-paprika/rust/pkg/obsidian_paprika_bg.wasm"() {
    obsidian_paprika_bg_default = "./obsidian_paprika_bg-WMQHLF7X.wasm";
  }
});
...
var imports, instance, module, memory;
var init_obsidian_paprika_bg2 = __esm({
  async "wasm-module:/Users/tdresser/personal/git/obsidian-paprika/rust/pkg/obsidian_paprika_bg.wasm"() {
    ...
    imports = {};
    ({ instance, module } = await loadWasm(obsidian_paprika_bg_default, imports));
